...
// TestIntegrationOrderRepository runs integration tests for the OrderRepository.
// It skips the test when running in short mode and executes the OrderRepositoryTestSuite
// which contains the actual test cases for order repository operations.
func TestIntegrationOrderRepository(t *testing.T) {
